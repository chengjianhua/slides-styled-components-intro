      ...
      >
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary">
          <BlockQuote>
            <Quote textSize="32px">
              ...
              styles private to components (as you should), you basically end up
              with CSS-in-JS anyway.
            </Quote>
            <Cite>
              <Link
                target="_blank"
        ...
        <Slide transition={["slide", "fade"]}>
          ...
          <List textColor="tertiary">
            <ListItem>
              <S type="bold">Highly Semantic</S>
            </ListItem>

            <ListItem>No required for preprocessor</ListItem>

            <ListItem>Sharing it is easy</ListItem>
          </List>
        </Slide>
        ...
        <Slide transition={["fade", "zoom"]}>
          ...
          <List textColor="tertiary">
            ...
            <ListItem>
              <S type="bold">The size of bundle is too big?</S>{" "}
              {/* <S type="normal" textColor="secondary">
                  (...)
                </S> */}
            </ListItem>
        ...
        <Slide transition={["slide"]} bgColor="primary">
          ...
          <List textColor="secondary">
            ...
            <ListItem>
              发布 npm 包时可以输出为该格式, 将大幅提升 runtime 计算出样式的速度
            </ListItem>
